...
export function Home() {
  return (
    <section
      className="h-full w-full min-h-[700px] bg-transparent flex flex-col lg:flex-row items-center justify-center gap-8 px-5 py-3"
      id="home"
    >
      ...
      <div className="lg:max-w-[60%] flex flex-auto flex-col justify-center items-end  ">
        <div className="flex flex-col  max-w-2xl gap-12 ">
          <Typewriter text="Hi, I'm Uerik" />
          <p className="lg:text-3xl text-teal-400 text-justify">
            Sou um desenvolvedor back-end júnior, apaixonado por tecnologia e
            programação. Tenho facilidade de aprendizado, e minhas principais
            linguagens são{" "}
            ...
            . Atualmente, não estou empregado, mas estou sempre em busca de
