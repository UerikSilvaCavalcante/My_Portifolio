  ...
  return (
    <div className="h-full flex flex-col items-center lg:items-start justify-center lg:justify-start gap-4 mt-3 ">
      ...
      <div
        className={
          flexCol
            ? "flex flex-col  items-center gap-7 p-2 bg-gradient-to-r to-green-600 from-teal-400 rounded-xl origin-left back"
            : "flex items-center flex-col lg:flex-row gap-7 p-2 bg-gradient-to-r to-green-600 from-teal-400 rounded-xl origin-left back"
        }
      >
        {icons.map(({ icon, alt }) => {
          return (
